...
class TestZSetBatch(unittest.TestCase):
    ...
    def _mk_payload(self, s, i):
        ...
        return create_test_row(self.schema, [s, i])
    ...
    def test_batch_append_and_clear(self):
        ...
        b.append(r_uint128(1), r_int64(1), self._mk_payload("a", 10))
    ...
    def test_batch_sorting_logic(self):
        ...
        b.append(pk1, r_int64(1), self._mk_payload("aaa", 1)) # First (same PK, lower string)
        ...
        # Payload column 0 is String, column 1 is I64
    ...
    def test_complex_consolidation_interleaving(self):
        ...
        b.append(r_uint128(10), r_int64(1), self._mk_payload("survive", 1))
        b.append(r_uint128(10), r_int64(1), self._mk_payload("survive", 1))
        
        # 2. Becomes a ghost
        b.append(r_uint128(20), r_int64(1), self._mk_payload("die", 1))
        b.append(r_uint128(20), r_int64(-1), self._mk_payload("die", 1))
        
        # 3. Survives with weight -1
        b.append(r_uint128(30), r_int64(-1), self._mk_payload("retract", 1))
        
        b.sort()
        b.consolidate()
        
        self.assertEqual(b.length(), 2)
        self.assertEqual(b.get_pk(0), r_uint128(10))
        self.assertEqual(b.get_weight(0), r_int64(2))
        self.assertEqual(b.get_pk(1), r_uint128(30))
        self.assertEqual(b.get_weight(1), r_int64(-1))

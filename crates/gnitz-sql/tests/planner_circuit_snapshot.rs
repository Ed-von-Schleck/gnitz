...
#5 MAP_REINDEX params:[(PROJ,0,0,0);(REINDEX,0,1,0);(ROUTE_KEY,0,1,0)] <- (#6@0)
#6 SCAN_DELTA src:base:ers_a
#7 INTEGRATE_TRACE <- (#8@0)
#8 MAP_REINDEX params:[(PROJ,0,1,0);(REINDEX,0,0,0);(ROUTE_KEY,0,1,0)] <- (#9@0)
...
#10 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(REINDEX,0,1,0);(ROUTE_KEY,0,1,0)] <- (#11@0)
#11 SCAN_DELTA src:base:l
#12 INTEGRATE_TRACE <- (#13@0)
#13 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(REINDEX,0,0,0);(ROUTE_KEY,0,1,0)] <- (#14@0)
...
#5 MAP_REINDEX params:[(PROJ,0,1,0);(PROJ,1,2,0);(PROJ,2,3,0);(PROJ,3,4,0);(PROJ,4,5,0);(PROJ,5,6,0);(REINDEX,0,0,0);(REINDEX,1,4,0);(ROUTE_KEY,0,0,0)] <- (#6@0)
...
#11 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(PROJ,2,2,0);(PROJ,3,3,0);(PROJ,4,4,0);(PROJ,5,5,0);(PROJ,6,6,0);(PROJ,7,7,0);(REINDEX,0,2,0);(ROUTE_KEY,0,0,0)] <- (#12@0)
#12 UNION <- (#13@0,#20@1)
...
#15 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(PROJ,2,2,0);(REINDEX,0,1,0);(REINDEX,1,2,0);(ROUTE_KEY,0,1,0)] <- (#16@0)
#16 SCAN_DELTA src:base:bls_a
#17 INTEGRATE_TRACE <- (#18@0)
#18 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(PROJ,2,2,0);(REINDEX,0,1,0);(REINDEX,1,2,0);(ROUTE_KEY,0,1,0)] <- (#19@0)
...
#23 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(PROJ,2,2,0);(REINDEX,0,0,0);(ROUTE_KEY,0,0,0)] <- (#16@0)
#24 MAP_PROJ params:[(PROJ,0,4,0);(PROJ,1,5,0);(PROJ,2,6,0);(PROJ,3,7,0);(PROJ,4,8,0);(PROJ,5,9,0)] <- (#25@0)
#25 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(PROJ,2,2,0);(PROJ,3,3,0);(PROJ,4,4,0);(PROJ,5,5,0);(PROJ,6,6,0);(PROJ,7,7,0);(REINDEX,0,2,0);(REINDEX,1,5,0);(ROUTE_KEY,0,0,0)] <- (#12@0)
"#;
...
#5 MAP_REINDEX params:[(PROJ,0,1,0);(PROJ,1,2,0);(PROJ,2,3,0);(PROJ,3,4,0);(REINDEX,0,0,0);(REINDEX,1,3,0);(ROUTE_KEY,0,0,0)] <- (#6@0)
#6 NULL_EXTEND params:[(NULL_EXT,0,9,0);(NULL_EXT,1,9,0)] <- (#7@0)
#7 UNION <- (#8@0,#13@1)
#8 MAP_PROJ params:[(PROJ,0,2,0);(PROJ,1,3,0)] <- (#9@0)
#9 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(PROJ,2,2,0);(REINDEX,0,1,0);(ROUTE_KEY,0,0,0)] <- (#10@0)
#10 WORKER_FILTER <- (#11@0)
#11 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(REINDEX,0,1,0);(ROUTE_KEY,0,1,0)] <- (#12@0)
#12 SCAN_DELTA src:base:pls_a
#13 NEGATE <- (#14@0)
#14 MAP_PROJ params:[(PROJ,0,2,0);(PROJ,1,3,0)] <- (#15@0)
#15 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(PROJ,2,2,0);(REINDEX,0,1,0);(ROUTE_KEY,0,0,0)] <- (#16@0)
#16 UNION <- (#17@0,#25@1)
...
#20 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(REINDEX,0,1,0);(ROUTE_KEY,0,0,0)] <- (#21@0)
#21 REDUCE params:[(AGG_SPEC,0,4,1)] <- (#22@0)
#22 MAP_HASH_ROW params:[(PROJ,0,0,0);(BRANCH_ID,0,0,0)] <- (#23@0)
#23 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(REINDEX,0,1,0);(ROUTE_KEY,0,1,0)] <- (#24@0)
...
#29 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(PROJ,2,2,0);(PROJ,3,3,0);(PROJ,4,4,0);(REINDEX,0,1,0);(REINDEX,1,3,0);(ROUTE_KEY,0,0,0)] <- (#30@0)
#30 UNION <- (#31@0,#35@1)
...
#9 JOIN_DELTA_TRACE <- (#10@0,#12@1)
#10 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(PROJ,2,2,0);(REINDEX,0,1,0);(ROUTE_KEY,0,1,0)] <- (#11@0)
#11 SCAN_DELTA src:base:eq_a
#12 INTEGRATE_TRACE <- (#13@0)
#13 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(REINDEX,0,1,0);(ROUTE_KEY,0,1,0)] <- (#14@0)
...
#8 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(PROJ,2,2,0);(REINDEX,0,1,0);(ROUTE_KEY,0,1,0)] <- (#9@0)
...
#11 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(PROJ,2,2,0);(REINDEX,0,1,0);(ROUTE_KEY,0,1,0)] <- (#12@0)
#12 SCAN_DELTA src:base:a
#13 INTEGRATE_TRACE <- (#14@0)
#14 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(REINDEX,0,1,0);(ROUTE_KEY,0,1,0)] <- (#15@0)
...
#9 JOIN_DELTA_TRACE <- (#10@0,#12@1)
#10 MAP_REINDEX params:[(PROJ,0,0,0);(REINDEX,0,1,0);(ROUTE_KEY,0,1,0)] <- (#11@0)
#11 SCAN_DELTA src:base:a
#12 INTEGRATE_TRACE <- (#13@0)
#13 MAP_REINDEX params:[(PROJ,0,2,0);(REINDEX,0,1,0);(ROUTE_KEY,0,1,0)] <- (#14@0)
...
#3 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(PROJ,2,2,0);(PROJ,3,3,0);(PROJ,4,4,0);(PROJ,5,5,0);(REINDEX,0,1,0);(REINDEX,1,4,0);(ROUTE_KEY,0,0,0)] <- (#4@0)
#4 UNION <- (#5@0,#14@1)
...
#7 MAP_REINDEX params:[(PROJ,0,0,0);(PROJ,1,1,0);(PROJ,2,2,0);(REINDEX,0,2,0);(ROUTE_KEY,0,1,0)] <- (#8@0)
...
#3 MAP_PROJ params:[(PROJ,0,1,0);(PROJ,1,2,0)] <- (#4@0)
#4 JOIN_DELTA_TRACE <- (#5@0,#7@1)
#5 MAP_REINDEX params:[(PROJ,0,2,0);(REINDEX,0,1,0);(ROUTE_KEY,0,1,0)] <- (#6@0)

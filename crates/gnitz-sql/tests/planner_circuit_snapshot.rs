...
#3 UNION <- (#4@0,#24@1)
#4 MAP_PROJ params:[(PROJ,0,3,0);(PROJ,1,4,0);(PROJ,2,5,0);(PROJ,3,6,0);(PROJ,4,7,0);(PROJ,5,8,0)] <- (#5@0)
...
#3 UNION <- (#4@0,#28@1)
#4 MAP_PROJ params:[(PROJ,0,3,0);(PROJ,1,4,0);(PROJ,2,5,0);(PROJ,3,6,0)] <- (#5@0)

...
fn lower_subquery<'a>(
    ...
    let agg_tc = crate::agg::agg_result_type(agg_func, agg_arg_col, &split.inner_schema.columns);
    Ok(LoweredSub {
        corr: split.corr,
...
fn lower_quantifier<'a>(
    ...
    let agg_tc = crate::agg::agg_result_type(agg_func, Some(col), &split.inner_schema.columns);
    Ok(LoweredSub {
        corr: split.corr,
        inner_tid: split.inner_tid,
        inner_schema: split.inner_schema,

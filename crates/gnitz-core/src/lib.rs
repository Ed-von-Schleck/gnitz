...
pub use types::{
    ...
    CIRCUIT_EDGES_TAB, CIRCUIT_NODES_TAB, CIRCUIT_NODE_COLUMNS_TAB, OPCODE_ANTI_JOIN_DELTA_DELTA,
    OPCODE_ANTI_JOIN_DELTA_TRACE, OPCODE_DELAY, OPCODE_DISTINCT, OPCODE_EXCHANGE_GATHER, OPCODE_EXCHANGE_SHARD,
    OPCODE_FILTER, OPCODE_INTEGRATE, OPCODE_INTEGRATE_TRACE, OPCODE_JOIN_DELTA_DELTA, OPCODE_JOIN_DELTA_TRACE,
    OPCODE_JOIN_DELTA_TRACE_OUTER, OPCODE_JOIN_DELTA_TRACE_RANGE, OPCODE_MAP, OPCODE_MAP_EXPR, OPCODE_MAP_PROJ,
    OPCODE_NEGATE, OPCODE_NULL_EXTEND, OPCODE_PARTITION_FILTER, OPCODE_REDUCE, OPCODE_SCAN_DELTA, OPCODE_SCAN_TRACE,
    OPCODE_SEMI_JOIN_DELTA_DELTA, OPCODE_SEMI_JOIN_DELTA_TRACE, OPCODE_UNION, OWNER_KIND_TABLE, OWNER_KIND_VIEW,

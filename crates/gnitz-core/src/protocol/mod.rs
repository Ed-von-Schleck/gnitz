...
pub use header::{
    ...
    FLAG_HAS_DATA, FLAG_HAS_PK, FLAG_HAS_SCHEMA, FLAG_PUSH, FLAG_PUSH_TXN, FLAG_SCAN_MULTI, FLAG_SCAN_SPEC, FLAG_SEEK,
    FLAG_SEEK_BY_INDEX, FLAG_SHUTDOWN, IPC_CONTROL_TID, MAX_COLUMNS, META_FLAG_IS_PK, META_FLAG_NULLABLE,
    SCAN_MULTI_MAX_RELATIONS, STATUS_ERROR, STATUS_NO_INDEX, STATUS_OK, STATUS_SCHEMA_MISMATCH, STATUS_TXN_CONFLICT,

...
pub(super) const FIRST_USER_SCHEMA_ID: i64 = 3;

pub(super) const OWNER_KIND_TABLE: i64 = 0;
pub(super) const OWNER_KIND_VIEW: i64 = 1;
...
pub(crate) const FIRST_USER_TABLE_ID: i64 = 16;
...
// System table IDs
pub(super) const SCHEMA_TAB_ID: i64 = 1;
pub(super) const TABLE_TAB_ID: i64 = 2;
pub(super) const VIEW_TAB_ID: i64 = 3;
pub(super) const COL_TAB_ID: i64 = 4;
pub(super) const IDX_TAB_ID: i64 = 5;
pub(super) const DEP_TAB_ID: i64 = 6;
pub(super) const SEQ_TAB_ID: i64 = 7;
pub(super) const CIRCUIT_NODES_TAB_ID: i64 = 11;
pub(super) const CIRCUIT_EDGES_TAB_ID: i64 = 12;
pub(super) const CIRCUIT_SOURCES_TAB_ID: i64 = 13;
pub(super) const CIRCUIT_PARAMS_TAB_ID: i64 = 14;
pub(super) const CIRCUIT_GROUP_COLS_TAB_ID: i64 = 15;

...
fn u64_col() -> SchemaColumn {
    SchemaColumn::new(type_code::U64, 0)
}
fn u32_col() -> SchemaColumn {
    SchemaColumn::new(type_code::U32, 0)
}
fn i64_col() -> SchemaColumn {
...
fn schema_roundtrip_catalog_preserves_pk_order() {
    let cols = vec![u64_col_def("payload"), u64_col_def("a"), u64_col_def("b")];

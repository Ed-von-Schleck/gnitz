...
impl DagEngine {
    ...
    pub fn reset_view_for_rebuild(&mut self, registry: &mut RelationRegistry, view_id: i64) -> Result<(), String> {
    ...
    pub fn collect_ephemeral_trace_tables<'a>(&'a mut self, registry: &RelationRegistry) -> Vec<&'a mut Table> {

...
from gnitz.backend import registry
...
class PersistentTable(AbstractTable):
    ...
    def create_scratch_table(self, name, schema):
        ...
        # Used by QueryBuilder for internal operator state (distinct, reduce).
        return PersistentTable(self.directory, name, schema)
...
registry.register('columnar', PersistentTable)
